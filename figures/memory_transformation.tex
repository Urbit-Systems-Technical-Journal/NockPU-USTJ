...
\textbf{Key:}
\begin{itemize}
  \item {\textmb Bold value}: Data atom (direct value like 50, 51, 3, 1)
  \item \underline{\texttt{Underlined value}}: Opcode (like Nock 2, 0, 4)
  \item {\textmt Normal value}: Pointer to memory location
  \item \colorbox{gray!20}{\textmt{Grayed cell}}: Memory address that has been modified
\end{itemize}
\end{minipage}
